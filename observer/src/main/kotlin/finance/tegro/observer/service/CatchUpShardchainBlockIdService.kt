...
@Service
class CatchUpShardchainBlockIdService(
    private val blockIdRepository: BlockIdRepository,
    private val catchUpMasterchainBlockService: CatchUpMasterchainBlockService,
    private val liteClient: LiteClient,
) {
    @OptIn(FlowPreview::class)
    val data = catchUpMasterchainBlockService.data
        ...
        .onEach { logger.trace { "old workchain=${it.workchain} block seqno=${it.seqno}" } }
        .shareIn(
            CoroutineScope(Dispatchers.IO + CoroutineName("CatchupShardchainBlockIdService")),
        ...
        val shardchainBlockIds = masterchainShards
            ...
            .mapNotNull { id ->
                try {
                    ...
                    logger.warn(e) { "couldn't get old shardchain block id workchain=${id.workchain} seqno=${id.seqno}" }
                    null
                }
            }
