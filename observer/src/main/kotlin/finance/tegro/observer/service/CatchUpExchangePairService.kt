...
@Service
class CatchUpExchangePairService(
    private val scheduler: Scheduler,
    private val exchangePairRepository: ExchangePairRepository,
    private val swapRepository: SwapRepository,
    private val catchUpTransactionService: CatchUpTransactionService,
) : CoroutineScope {
    override val coroutineContext = Dispatchers.IO + CoroutineName("CatchUpExchangePairService")

    val job = launch {
        catchUpTransactionService.data
