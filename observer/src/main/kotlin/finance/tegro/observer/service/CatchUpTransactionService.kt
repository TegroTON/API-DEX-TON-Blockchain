...
@Service
class CatchUpTransactionService(
    private val catchUpMasterchainBlockService: CatchUpMasterchainBlockService,
    private val catchUpShardchainBlockService: CatchUpShardchainBlockService,
) {
    @OptIn(FlowPreview::class)
    val data = merge(catchUpMasterchainBlockService.data, catchUpShardchainBlockService.data)
        ...
        .shareIn(
            CoroutineScope(Dispatchers.IO + CoroutineName("CatchUpTransactionService")),
